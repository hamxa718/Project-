...
class FrontController extends Controller
{
    ...
    public function loginRegisterVendor()
    {
        ...
        return view('front.loginRegisterVendor',compact('categories'));
    }
    ...
    {
        // $x = NULL;
        // foreach($request->main_category as $key => $value) {
        //     $x .= $value .", ";
        //   }
        //   $data['main_category'] = $x;
        ...
        $data['main_category'] = implode(',', $request->main_category);
            ...
            $user =  User::create([
                ...
                'role_id' => 2,
                'notify_status'=>$request->notify,
                'notify_category_id'=>$data['main_category'],
