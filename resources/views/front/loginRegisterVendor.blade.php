                                       ...
                                       {{ csrf_field() }}
                                         ...
                                         <p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
                                          ...
                                          <div class="for_customer" >
                                             <p class="form-row form-group form-row-wide">
                                                <label for="company-name">Would You Like To Notify <span class="">*</span></label> <br>
                                                <label for="yes">
                                                <input type="radio" id="yes" name="notify" value="1">Yes</label>
                                                <br>
                                                <label for="no">
                                                <input type="radio" id="no" name="notify" value="0" checked>No</label>
                                                <br></p>
                                          <div class="cat_sec">
                                             <p class="form-row form-group"><label for="exampleInputEmail1">Main Category</label><select class="woocommerce-Input woocommerce-Input--text input-text {{ $errors->has('main_category') ? 'has-error' : ''}}" name="main_category[]" multiple id="main-category" >@foreach ($categories as $category)<option value="{{$category->id}}">{{$category->name}}</option>@endforeach</select></p>
                                          </div>
                                          </div>
...
$(document).ready(function() {
   ...
   $('#yes').click(function() {
                 ...
                 $('.for_vender').html('');
                 $('.cat_sec').show('');
               //   $('.for_customer').html('<p class="form-row form-group form-row-wide"><label for="company-name">Would You Like To Notify <span class="">*</span></label> <br><input type="radio" id="yes" name="yes" value="1"><label for="Yes">Yes</label><br><input type="radio" id="no" name="no" value="0"><label for="no">No</label><br></p><p class="form-row form-group"><label for="exampleInputEmail1">Main Category</label><select class="woocommerce-Input woocommerce-Input--text input-text {{ $errors->has('main_category') ? 'has-error' : ''}}" name="main_category" id="main-category" required><option value="" disabled selected>Select Category</option>@foreach ($categories as $category)<option value="{{$category->id}}">{{$category->name}}</option>@endforeach</select>');
              });
               $('#customer_add_fields').click(function() {
                 $('.for_broker').html('');
                 $('.for_vender').html('');
                 $('.for_customer').show();
               //   $('.for_customer').html('<p class="form-row form-group form-row-wide"><label for="company-name">Would You Like To Notify <span class="">*</span></label> <br><input type="radio" id="yes" name="yes" value="1"><label for="Yes">Yes</label><br><input type="radio" id="no" name="no" value="0"><label for="no">No</label><br></p>');
              });
